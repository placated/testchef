...
node.set_unless['wordpress']['db']['password'] = "willjames"
node.set_unless['wordpress']['keys']['auth'] = "willjames"
node.set_unless['wordpress']['keys']['secure_auth'] = "willjames"
node.set_unless['wordpress']['keys']['logged_in'] = "willjames"
node.set_unless['wordpress']['keys']['nonce'] = "willjames"
